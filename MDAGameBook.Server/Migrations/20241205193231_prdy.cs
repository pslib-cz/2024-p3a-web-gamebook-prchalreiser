...
{
    /// <inheritdoc />
    public partial class prdy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDrinkable = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Withdrawal = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Minigames_Locations_LocationID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationID = table.Column<Guid>(type: "TEXT", nullable: false),
                    ItemsForSale = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VictoryReward = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Links_FromLocationID",
                table: "Links",
                column: "FromLocationID");

            migrationBuilder.CreateIndex(
                name: "IX_Links_ToLocationID",
                table: "Links",
                column: "ToLocationID");

            migrationBuilder.CreateIndex(
                name: "IX_Minigames_LocationID",
                table: "Minigames",
                column: "LocationID");
